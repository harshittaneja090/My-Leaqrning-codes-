...
main(){
	...
	system("cls");
	switch(s){
	hen:case 1:system("COLOR 2B");
	cout<<"Press a number\n\n1.Inline Functions\n2.Static Data Members and Member Function\n3.Friend Function\n4.Returning object from function";
	cout<<"\n\n\nEnter your choice:";
	cin>>t;
	system("cls");
	switch(t){
	case 1:system("COLOR 3C");
	...
	cout<<"\n\n\nValue of X:"<<x;
	break;
	case 3:system("COLOR 5E");
	cout<<"#include<iostream>\nusing namespace std;\nclass A\n{\nint x;\npublic:\nvoid get()\n{\ncout<<''Enter the value:'';\ncin>>x;\n}\nfriend void display(A);\n};\nvoid display(A obj)\n{\ncout<<''Value:''<<obj.x;\n}\nmain()\n{\nA obj,obj1;\nobj.get();\ndisplay(obj);\n}";
	cout<<"\n\n\nEnter the value:";
	cin>>x;
	cout<<"Value:"<<x;
	break;
	case 4:system("COLOR 6F");
    ...
    break;
    case 3:system("COLOR 3A");
	label5:cout<<"Press a number\n1.Simple Inheritance\n2.Hierarichal Inheritance\n3.Multiple Inheritance\n4.Hybrid Inheritance\n5.Multilevel Inheritance";
	cout<<"\nEnter your choice:";
	cin>>m;
	system("cls");
	switch(m){
		case  1:system("COLOR 4B");cout<<" ____simple___ inheritance__:\n\n\nprogram:-";
...
break;
 case  5:system("COLOR 8F");
    ...
    break;
	case 4:system("COLOR 9A");
	label1:cout<<"\nPress a number\n\n1.Function Overloading\n2.Constructor Overloading\n3.Operator Overloading";
    cout<<"\n\n\nEnter your choice:";
    cin>>p;
    system("cls");
    switch(p){
    	case 1:system("COLOR 1B");
		...
		break;
    	case 2:system("COLOR 2C");
		cout<<"#include<iostream>\nusing namespace std;\nclass construct\n{\npublic:\nfloat area;\nconstruct()\n{\narea = 0;\n}\nconstruct(int a, int b)\n{\narea = a * b;\n}\nvoid disp()\n{\ncout<<''Area:''<<area<< endl;\n}\n};\nmain()\n{\nconstruct o;\nconstruct o2( 10, 20);\no.disp();\no2.disp();\n}";
    	cout<<"\n\n\nArea=0\nArea=200";
		break;
		case 3:system("COLOR 3D");
